  ...
  return (
    <div className="p-8 flex items-center justify-center">
      <div className="w-full max-w-lg">
        <form className="bg-gray-900 border border-gray-800 rounded shadow px-8 pt-6 pb-8 mb-4">
          <div className="flex flex-wrap -mx-3 mb-2">
            <div className="w-full md:w-1/2 px-3 mb-2 md:mb-0">
              ...
              <input
                ...
                className="appearance-none h-8 block w-full bg-gray-700 text-gray-700 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white"
                name="firstName"
                type="text"
